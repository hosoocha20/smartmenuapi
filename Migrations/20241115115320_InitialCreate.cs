        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosProvider = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MyTables_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubHeaderImgUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SidebarColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SidebarTextColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SidebarSelectedColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BodyColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BodyHeaderTextColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MenuItemBodyColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MenuItemTextColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MenuItemPriceColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SubCategoryTextColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Themes_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_MenuSubCategories_MenuSubCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_MenuSubCategoryId",
                table: "Products",
